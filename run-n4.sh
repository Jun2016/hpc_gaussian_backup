...
while [ "$1" != "" ]; do
    ...
    # Step 2 - row cyclic
    mpiexec -n 4 step_2/step_2.x -g 4x1 \
        -i ${DATA_DIR}/matrix_${SIZE}.mm -o step_2/res_${SIZE}_step_2_41.mm

    # Step 3 - total cyclic
    mpiexec -n 4 step_3/step_3.x -g 2x2 \
        -i ${DATA_DIR}/matrix_${SIZE}.mm -o step_3/res_${SIZE}_step_3_22.mm
    ...
    mpiexec -n 4 step_6/step_6.x -g 1x4 \
        -i ${DATA_DIR}/matrix_${SIZE}.mm -o step_6/res_${SIZE}_step_6_14.mm
